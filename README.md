...
<img src='http://i.imgur.com/zzCe3jD.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
...
The most challenging part was trying to debug my code when I couldn't compose a tweet. After a while, I found out that
I was overriding the wrong onFailure method which, after correctly implmenting the right one, led me to the error which
was that I only had read only permissions from my access token.
